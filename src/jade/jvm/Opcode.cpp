...
constexpr OpcodeInfo kTable[256] = {
    ...
    /* 0xB2 */ {"getfield",       OperandFormat::U2,        true,  true,  false, false, true, false},
    /* 0xB3 */ {"putfield",       OperandFormat::U2,        false, true,  false, false, true, false},
    /* 0xB4 */ {"getstatic",      OperandFormat::U2,        true,  false, false, false, true, false},
    /* 0xB5 */ {"putstatic",      OperandFormat::U2,        false, true,  false, false, true, false},
