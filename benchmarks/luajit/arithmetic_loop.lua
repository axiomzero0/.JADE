...
-- Computes sum of i*3+1 for i in [0, N) in a tight loop.
...
print(string.format("Benchmark: ArithmeticLoop (LuaJIT)"))
print(string.format("  N = %d", N))
print(string.format("  Result = %d", result))
print(string.format("  Expected = %d", N * (N - 1) / 2 * 3 + N))
print(string.format("  Correct = %s", result == (N * (N - 1) / 2 * 3 + N) and "True" or "False"))
